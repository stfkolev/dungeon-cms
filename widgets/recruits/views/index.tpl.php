	...
	<li class="list-group-item">
		<div class="pull-right">
			...
			<?php else: ?>
				...
				<span class="label label-default" data-toggle="tooltip" title="To join the team <?php echo $recruit['team_name']; ?>"><?php echo icon('fa-gamepad'); ?></span>
				<?php endif; ?>
				<span class="label label-default" data-toggle="tooltip" title="<?php echo ($recruit['size'] - $recruit['candidacies_accepted']) > 1 ? 'posts' : 'post'; ?>"><?php echo icon('fa-briefcase').' '.($recruit['size'] - $recruit['candidacies_accepted']); ?></span>
			<?php endif; ?>
		</div>
