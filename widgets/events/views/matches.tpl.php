		...
		<div class="row">
			...
			<div class="text-left col-md-<?php echo $match['match']['opponent']['image_id'] ? 7 : 8; ?>">
				...
				<?php
					...
					{
						$opponent .= '<img src="'.url('dungeon/themes/default/images/flags/'.$match['match']['opponent']['country'].'.png').'" data-toggle="tooltip" title="'.get_countries()[$match['match']['opponent']['country']].'" style="margin-left: 10px;" alt="" />';
					}
