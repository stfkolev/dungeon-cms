...
<ul class="list-group">
	...
	<li class="list-group-item">
		<?php if ($event['type'] == 1): ?>
			...
			{
				$opponent .= '<img src="'.url('dungeon/themes/default/images/flags/'.$match['opponent']['country'].'.png').'" data-toggle="tooltip" title="'.get_countries()[$match['opponent']['country']].'" style="margin-left: 10px;" alt="" />';
			}
