...
<link rel="stylesheet" href="<?php echo css('dungeon.notify.css'); ?>" type="text/css" media="screen" />
<?php echo $data['css']; ?>
...
<body>
	<?php if ($this->config->dungeon_maintenance && !$this->url->admin && isset($this->user) && $this->user('admin') && Dungeon()->module->name != 'live_editor'): ?>
	...
	<script type="text/javascript" src="<?php echo js('dungeon.notify.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo js('dungeon.user.js'); ?>"></script>
	<?php echo $data['js']; ?>
	...
	<?php echo $this->config->dungeon_analytics; ?>
	</script>
</body>
</html>