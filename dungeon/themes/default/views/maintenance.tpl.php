<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<?php if ($this->config->dungeon_maintenance_logo): ?>
			<img src="<?php echo path($this->config->dungeon_maintenance_logo); ?>" class="logo" alt="" />
			<?php else: ?>
			<span class="navbar-brand"><?php echo $this->config->dungeon_name; ?></span>
			<?php endif; ?>
		</div>
		<div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			<ul class="nav navbar-nav">
				<?php
					...
					{
						if ($url = $this->config->{'dungeon_maintenance_'.$name})
						{
...
<section class="intro">
	<div class="intro-body">
		<div class="container">
			...
			<p class="intro-text"><?php echo bbcode($this->config->dungeon_maintenance_content) ?: $this->lang('our_website_is_unavailable'); ?></p>
			<?php if ($this->config->dungeon_maintenance_opening): ?>
				<?php echo $this->lang('coming_soon'); ?>
				<div id="countdown" class="countdownHolder" data-timestamp="<?php echo date_create($this->config->dungeon_maintenance_opening)->getTimestamp(); ?>"></div>
			<?php endif; ?>
		</div>
	</div>
</section>
