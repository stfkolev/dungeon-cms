...
abstract class Driver
{
	...
	public function debug()
	{
		...
		return geshi_highlight($this->sql, 'sql', NULL, TRUE).(!empty($this->bind) ? '<br />'.Dungeon()->debug->table($this->bind) : '').(!empty($this->error) ? '<div class="alert alert-danger">'.$this->error.'</div>' : '');
	}
}

/*
Dungeon Alpha 0.1.7
./dungeon/classes/driver.php
*/