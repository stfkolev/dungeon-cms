<div class="list-group">
	<a href="<?php echo url('user'); ?>" class="list-group-item<?php echo !isset($this->url->segments[1]) ? ' active' : ''; ?>"><?php echo icon('fa-user'); ?> My space</a>
	<a href="<?php echo url('user/edit'); ?>" class="list-group-item<?php echo isset($this->url->segments[1]) && $this->url->segments[1] == 'edit' ? ' active' : ''; ?>"><?php echo icon('fa-cogs'); ?> Manage my account</a>
	<a href="<?php echo url('user/messages'); ?>" class="list-group-item">
		...
		<?php endif; ?>
		<?php echo icon('fa-envelope-o'); ?> Private messages
	</a>
