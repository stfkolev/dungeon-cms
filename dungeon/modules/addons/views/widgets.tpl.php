	...
	<div class="addon-item<?php echo $this->addons->is_enabled($widget->name, 'widget') ? ' active' : ''; ?>" data-name="<?php echo $widget->name; ?>">
		<div class="item-status">
			<div class="item-status-icon">
				<?php echo $this->addons->is_enabled($widget->name, 'widget') ? '<span data-toggle="tooltip" title="Active">'.icon('fa-check').'</span>' : '<span data-toggle="tooltip" title="Deactivated">'.icon('fa-ban').'</span>'; ?>
			</div>
			<div class="item-status-switch">
				<?php if ($deactivatable) echo $this->addons->is_enabled($widget->name, 'widget') ? '<a href="#" data-toggle="tooltip" title="Deactivate widget">'.icon('fa-toggle-on text-green').'</a>' : '<a href="#" data-toggle="tooltip" title="Activate widget">'.icon('fa-toggle-off text-muted').'</a>'; ?>
			</div>
			<div class="item-name">
