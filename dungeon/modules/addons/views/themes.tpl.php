...
<?php foreach ($this->addons->get_themes() as $theme): ?>
	<div class="col-md-12 col-lg-4">
		<div class="thumbnail thumbnail-theme<?php if ($active = $theme->name == $this->config->dungeon_default_theme) echo ' panel-primary'; ?>" role="button" data-theme="<?php echo $theme->name; ?>" data-title="<?php echo $theme->get_title(); ?>">
			<div class="row">
