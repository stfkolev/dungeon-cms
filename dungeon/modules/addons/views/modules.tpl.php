	...
	<div class="addon-item<?php echo $this->addons->is_enabled($module->name, 'module') ? ' active' : ''; ?>" data-name="<?php echo $module->name; ?>">
		<div class="item-status">
			<div class="item-status-icon">
				<?php echo $this->addons->is_enabled($module->name, 'module') ? '<span data-toggle="tooltip" title="Active">'.icon('fa-check').'</span>' : '<span data-toggle="tooltip" title="Deactivated">'.icon('fa-ban').'</span>'; ?>
			</div>
			<div class="item-status-switch">
				<?php if ($deactivatable) echo $this->addons->is_enabled($module->name, 'module') ? '<a href="#" data-toggle="tooltip" title="Deactivate component">'.icon('fa-toggle-on text-green').'</a>' : '<a href="#" data-toggle="tooltip" title="Activate component">'.icon('fa-toggle-off text-muted').'</a>'; ?>
			</div>
			<div class="item-name">
