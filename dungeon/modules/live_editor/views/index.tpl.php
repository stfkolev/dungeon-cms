<form target="live-editor-iframe" action="<?php echo url(); ?>" method="post">
	<input type="hidden" name="live_editor" value="<?php echo $live_editor = $this->session('live_editor') ?: Dungeon::LIVE_EDITOR ^ Dungeon::WIDGETS; ?>" />
	<nav class="live-editor-navbar">
		...
		<div class="pull-right">
			...
			<div class="btn-group">
				<button type="button" class="live-editor-mode<?php echo $live_editor & Dungeon::ZONES ? ' active' : ''; ?>" data-mode="<?php echo Dungeon::ZONES; ?>"><?php echo icon('fa-square-o').' '.$this->lang('zones'); ?></button>
				<button type="button" class="live-editor-mode<?php echo $live_editor & Dungeon::ROWS ? ' active' : ''; ?>" data-mode="<?php echo Dungeon::ROWS; ?>"><?php echo icon('fa-columns fa-rotate-270').' '.$this->lang('rows'); ?></button>
				<button type="button" class="live-editor-mode<?php echo $live_editor & Dungeon::COLS ? ' active' : ''; ?>" data-mode="<?php echo Dungeon::COLS; ?>"><?php echo icon('fa-columns').' '.$this->lang('cols'); ?></button>
				<button type="button" class="live-editor-mode active" data-mode="<?php echo Dungeon::WIDGETS; ?>"><?php echo icon('fa-th-large').' '.$this->lang('widgets'); ?></button>
			</div>
