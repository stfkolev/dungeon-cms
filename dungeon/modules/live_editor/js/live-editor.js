...
$(function(){
	var $widgets = $('[data-mode="<?php echo Dungeon::WIDGETS; ?>"]');
	...
	$('.live-editor-mode').click(function(){
		...
		if ($(this).data('mode') == <?php echo Dungeon::WIDGETS; ?>){
			return;
		}

		var mode = <?php echo Dungeon::LIVE_EDITOR; ?>;
	...
	$('.live-editor-iframe iframe').bind('load', function(){
		...
		$iframe.on('click', '.live-editor-add-row', function(){
			...
			$.post('<?php echo url('ajax/live-editor/row-add'); ?>', {
				...
				var $rows_button = $('.live-editor-mode[data-mode="<?php echo Dungeon::ROWS; ?>"]');
		...
		$iframe.on('click', '.live-editor-add-col', function(){
			...
			$.post('<?php echo url('ajax/live-editor/col-add'); ?>', {
				...
				var $cols_button = $('.live-editor-mode[data-mode="<?php echo Dungeon::COLS; ?>"]');
