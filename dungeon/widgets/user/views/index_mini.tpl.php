<ul class="nav navbar-nav <?php echo !empty($data['align']) ? $data['align'] : 'navbar-right'; ?>">
	<?php if ($this->user()): ?>
		...
		<li data-toggle="tooltip" title="My Settings"><a href="<?php echo url('user/edit'); ?>"><?php echo icon('fa-cogs'); ?></a></li>
		<li data-toggle="tooltip" title="My Messages">
		...
		<?php endif; ?>
		<li data-toggle="tooltip" title="Logout"><a href="<?php echo url('user/logout'); ?>"><?php echo icon('fa-close'); ?></a></li>
	<?php else: ?>
