...
<ul class="list-inline no-margin">
	...
	<li><a href="<?php echo url(($this->url->admin) ? 'admin/events/matches' : 'events/matches'); ?>"><?php echo ($this->url->request == 'events/matches' || $this->url->request == 'events/matches/list' || $this->url->request == 'admin/events/matches') ? '<b>Results</b>' : 'Results'; ?></a></li>
